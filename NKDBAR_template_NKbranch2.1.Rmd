...
<!-- Type ?knitr::knit and see 'Notes' section for information on working directories. The RStudio wd is separate from the knitr *.Rmd wd. -->
...
Let's also view the normalized boxplots by normalizing each unit's data first. 
